...
const mockProducts: Product[] = [
    ...
    },
    {
        ...
        description: "Ancient missile launcher designed to hurl javelins or heavy balls. ",
    },
    {
        id: 5,
    ...
    },
    {
        ...
        description: "A curved, single-edged sword of Asian, especially Eastern origin.",
    },
    {
        id: 7,
        title: "Roman Scutum",
...
// obvs it dosent get related products, cause we dont have any way to track that (:
export function getAmountOfProducts(amount: number) {
    const { products } = useProduct();
    // failsafe
